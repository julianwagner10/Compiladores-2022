...
case 23:
#line 50 "gramatica.y"
{System.out.println("[Parser | linea " + Lexico.linea + "] se leyo una lista de variables con identificador -> " + yyvsp[0].sval);}
break;
case 25:
#line 54 "gramatica.y"
...
{System.out.println("[Parser | Linea " + Lexico.linea + "] se detecto una sentencia de tipo DISCARD ");}
break;
case 57:
#line 106 "gramatica.y"
{System.out.println("[Parser | Linea " + Lexico.linea + "] se detecto una sentencia de control con etiqueta: " +yyvsp[-3].sval);}
break;
case 61:
...
{System.out.println("[Parser | Linea " + Lexico.linea + "] se detecto una sentencia ejecutable CONTINUE con etiqueta: " +yyvsp[-1].sval);}
break;
case 76:
